...
SIMPLE 2D Lid-Driven Cavity Solver (Finite Volume, Staggered Grid, Iterative, Python Version)
...
Usage:
    ...
    - Run: python IterativeSolver.py
    - Adjust parameters at the top of the file as needed
    - GIFs and summary plots are generated in the working directory

Features:
    - Modular, triple-nested-loop implementation for educational clarity and benchmarking
...
def main():
    ...
    while sim_time < total_time:
        ...
        # SIMPLE Inner Iterations (loops, not vectorized)
