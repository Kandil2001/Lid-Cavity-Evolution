...
u_star(jj,ii) = u(jj,ii) + alpha_dt _(-du2dx - duvdy - dpdx + nu_(d2udx2 + d2udy2));
...
v_star(jj,ii) = v(jj,ii) + alpha_dt _(-duvdx - dv2dy - dpdy + nu_(d2vdx2 + d2vdy2));
end
...
n = size(p,1);
alpha_dt_dx = alpha _dt / dx; alpha_dt_dy = alpha_ dt / dy;
ii = 2:n-1; jj = 2:n-1;
u = u_star; v = v_star;
